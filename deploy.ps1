...
Delete-IfExists -resourceType "configmap" -filePath "k8s/monitoring/grafana/grafana-dashboards-configmap.yml"
Delete-IfExists -resourceType "configmap" -filePath "k8s/monitoring/grafana/grafana-datasources-configmap.yml"
Delete-IfExists -resourceType "configmap" -filePath "k8s/monitoring/grafana/grafana-provisioning.yml"
