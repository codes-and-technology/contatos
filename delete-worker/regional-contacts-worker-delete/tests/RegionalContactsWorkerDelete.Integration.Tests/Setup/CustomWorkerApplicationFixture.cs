...
namespace RegionalContactsWorkerDelete.Integration.Tests.Setup
{
        ...
        public void ConfigureWebHost()
        {
            ...
            Host = Microsoft.Extensions.Hosting.Host.CreateDefaultBuilder()
                    ...
                    .ConfigureServices((hostContext, services) =>
                    {
                        ...
                        services.AddScoped<IDeleteContactGateway, DeleteContactGateway>();
                        services.AddScoped<IDeleteContactController, DeleteContactController>();
